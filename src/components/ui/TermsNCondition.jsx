...
const TermAndCondition = (    { isConditionModalOpen ,setIsConditionModalOpen  ,acceptTerms ,setAcceptTerms  }) => {
  ...
  return (
    <>
      <Modal
       ...
       open={isConditionModalOpen} onOk={handleOk} onCancel={handleCancel}>
        <BlueText
            style={{
                fontWeight:"800",
                fontSize:"24px",
